# Team 4 - Working Guidelines & Expectations

This document outlines our team's working agreements, communication protocols, and expectations for collaboration.
...
**Regular Meeting Day/Time:** [To be decided]  
**Meeting Platform:** [Zoom/Teams/Discord]  
...
- [ ] Take notes on your own action items
...
- [ ] Coordinate with instructor if needed
- [ ] Select next week's leader at end of meeting
...
1. **Direct Communication:** Talk directly with involved parties first
2. **Team Discussion:** Bring to full team if needed
3. **Democratic Vote:** Vote if consensus can't be reached
4. **Team Leader:** Leader makes final call if vote is tied
...
- Keep instructor informed of major issues
...
[Space for team to add notes or suggest changes to guidelines]
