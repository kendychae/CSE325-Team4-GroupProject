        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOpportunities_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRegistrations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceRegistrations_ServiceOpportunities_OpportunityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOpportunities_Category",
                table: "ServiceOpportunities",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOpportunities_CreatedByUserId",
                table: "ServiceOpportunities",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOpportunities_IsActive",
                table: "ServiceOpportunities",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOpportunities_StartDate",
                table: "ServiceOpportunities",
                column: "StartDate");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRegistrations_OpportunityId",
                table: "ServiceRegistrations",
                column: "OpportunityId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRegistrations_UserId_OpportunityId",
                table: "ServiceRegistrations",
